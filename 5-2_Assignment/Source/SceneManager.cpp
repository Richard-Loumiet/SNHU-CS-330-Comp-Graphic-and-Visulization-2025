...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture(
		"C:/CS330Content/Projects/5-2_Assignment/Images/Brick-Base.jpg", "floor"
	);

	// Gold Rod
	bReturn = CreateGLTexture(
		"C:/CS330Content/Projects/5-2_Assignment/Images/Brush-Gold.jpg", "cylinder"
	);

	// Red Cone
	bReturn = CreateGLTexture(
		"C:/CS330Content/Projects/5-2_Assignment/Images/Red-Brick.jpg", "cone"
	);
		
	// Wood Box
	bReturn = CreateGLTexture(
		"C:/CS330Content/Projects/5-2_Assignment/Images/Wood-Grain.jpg", "box"
	);
	
	// Blue Box
	bReturn = CreateGLTexture(
		"C:/CS330Content/Projects/5-2_Assignment/Images/Stone-Blue.jpg", "cube"
	);

	// Purple Sphere
	bReturn = CreateGLTexture(
		"C:/CS330Content/Projects/5-2_Assignment/Images/Stone-Purple.jpg", "sphere"
	);
